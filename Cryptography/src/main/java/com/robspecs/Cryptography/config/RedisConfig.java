...
public class RedisConfig {
    ...
    public RedisConnectionFactory redisConnectionFactory() {
        ...
        // It's good practice to call afterPropertiesSet() if not managed by Spring's full lifecycle
        // lettuceConnectionFactory.afterPropertiesSet(); // Usually not needed if Spring manages the bean lifecycle
    ...
    public RedisMessageListenerContainer redisContainer(RedisConnectionFactory cf,
                                                        ...
                                                        ,TaskExecutor redisMessageExecutor) {
        ...
        // container.afterPropertiesSet(); // Not strictly necessary if Spring manages lifecycle
    ...
    public MessageListenerAdapter listenerAdapter(RedisSubscriber subscriber) {
        ...
        // The 'onMessage' method in RedisSubscriber will be invoked when a message arrives
    ...
    public TaskExecutor redisMessageExecutor() {
        ...
        executor.initialize();
        logger.debug("TaskExecutor 'redisMessageExecutor' initialized with corePoolSize={}, maxPoolSize={}, queueCapacity={}",
