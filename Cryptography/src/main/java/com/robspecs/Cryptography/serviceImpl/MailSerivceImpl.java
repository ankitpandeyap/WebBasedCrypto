...
public class MailSerivceImpl implements MailService {
    ...
    public void sendOtpEmail(String email, String otp) {
        try {
            ...
            MimeMessageHelper helper = new MimeMessageHelper(message, true, "UTF-8"); // Use UTF-8
            ...
            throw new RuntimeException("Failed to send OTP email", e); // Wrap for more context
        }
    }
